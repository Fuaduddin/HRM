...
if(isset($_POST["submit"])){
    ...
    $supervisior = $_POST["supervisior"];
        if($name!=='')
        {
    $sql1= "UPDATE `employee` SET `name`='$name'  WHERE e_id='$sid'";
    ...
    if($query1){
        ...
        header('location:viewstaff.php');  
          ...
          if($email!=='')
        {
    $sql1= "UPDATE `employee` SET `email`='$email'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
               ...
               echo '<script>alert("Error while updating profile")</script>';
                ...
                if($phone!=='')
        {
    $sql1= "UPDATE `employee` SET `phone`='$phone'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
               ...
               echo '<script>alert("Error while updating profile")</script>';
                ...
                if($user!=='')
        {
    $sql1= "UPDATE `employee` SET `user`='$user'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
    ...
    $sql1= "UPDATE `employee` SET `password`='$password'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
               ...
               echo '<script>alert("Error while updating profile")</script>';
                ...
                if($imagename!=='')
        {
    $sql1= "UPDATE `employee` SET `image`='$imagename'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
               ...
               echo '<script>alert("Error while updating profile")</script>';
                ...
                if($address!=='')
        {
    $sql1= "UPDATE `employee` SET `address`='$address'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
               ...
               echo '<script>alert("Error while updating profile")</script>';
                 ...
                 if($gender!=='')
        {
    $sql1= "UPDATE `employee` SET `gender`='$gender'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
          ...
          if($id!=='')
        {
    $sql1= "UPDATE `employee` SET `user`='$id'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
        ...
        if($supervisior!=='')
        {
    $sql1= "UPDATE `employee` SET `supervisior`='$supervisior'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
        ...
        if($salary!=='')
        {
    $sql1= "UPDATE `employee` SET `salary`='$salary'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
        ...
        if($jcategory!=='')
        {
    $sql1= "UPDATE `employee` SET `jobcategory`='$jcategory'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
    ...
    if($query1){
        ...
        header('location:viewstaff.php');  
           ...
           if($jtitle!=='')
        {
    $sql1= "UPDATE `employee` SET `jobtitle`='$jtitle'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
        ...
        if($tleave!=='')
        {
    $sql1= "UPDATE `employee` SET `t_leave`='$tleave'  WHERE e_id='$sid'";
    $query1 = mysqli_query($con,$sql1);
    if($query1){
         echo '<script>alert("Your Account have been updated")</script>';
        header('location:viewstaff.php');  
                        ...
                        <select name="jtitle" type="text"  class="form-login" required>
                            ...
                            while($row=mysqli_fetch_array($te))
                            {
                                ...
                                <select name="category" type="text" class="form-login" required>
                                    ...
                                    <option value='' ><?php echo $supervisior; ?></option>
                                    <?php
                                    $con = mysqli_connect("localhost","root","","hrm");
